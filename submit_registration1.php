...
$stmt->bind_param("ssssssssssssssdddds", $learner, $parent, $dob, $gender, $email, $phone, $username, $password, $education, $billingAddress, $profilePicture, $subscription, $payment_option, $amount, $total_amount, $total_balance, $terms_agreed, $privacy_agreed, $payment_status);
