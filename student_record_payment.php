...
<body>
    <div class="container">
        ...
        <?php
            ...
            $query = "SELECT learner_name, username, email,  subscription, amount, payment_option, total_amount, balance, registration_date, payment_status FROM account_registration";
        ...
        <div class="btn-container">
            ...
            <a href="upload.php" class="btn">Insert Offical Learners</a>
            <a href="export.php" class="btn btn-edit">Export to CSV</a>
            <a href="paid_leaners.php" class="btn btn-edit">Official Learners</a>
